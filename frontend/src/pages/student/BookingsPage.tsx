    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-blue-100">Manage your tutoring sessions and schedule</p>
        </div>
        ...
        {!loading && filteredBookings.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-6">
              {filter === 'all'
                ? "You don't have any bookings yet. Browse tutors to get started!"
              ...
              <div key={booking.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-900 mb-2">{booking.tutorName}</h3>
                    <p className="text-gray-600 mb-2">📚 Subject: {booking.subject}</p>
                    <p className="text-gray-600 mb-2">📅 {new Date(booking.scheduledAt).toLocaleString()}</p>
                    <p className="text-blue-600 font-semibold">${booking.hourlyRate}/hour</p>
                  </div>
